...
setGeneric(
  ...
  def=function(
    ...
    #cp/ paste0(path.package("yourpackage"), "/your_text_file.txt")
    file.copy(paste0(path.package("biologicSC"), "/inst/ui.r"), ".")
    file.copy(paste0(path.package("biologicSC"), "/inst/server.r"), ".")
